...
inputs_rnn = tf.unstack(input_to_rnn, num=24, axis=1)
rnn_outputs,rnn_state= tf.contrib.rnn.static_rnn(lstm_cell,inputs_rnn,dtype=tf.float32)
...
input_to_classification = rnn_state[-1] # shape is [batch_size, HIDDEN_SIZE]
